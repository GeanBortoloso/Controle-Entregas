...
const DRIVERS = ["Wagner", "Lucas", "Ueriqui", "Natanael", "Flavio"];
const VEHICLES = ["FAN 160 (QCV-4G37)", "FAN 160 (QCI-0679)", "FAN 160 (QCV-4G37)", "FAN 160 (RAL-3G00)", "STRADA (BCJ-1F38)", "STRADA (RRY-9F54)", "STRADA (QBV-4372)", "MONTANA (SPD-2G30)", "MONTANA (SPD-2G90)"];
